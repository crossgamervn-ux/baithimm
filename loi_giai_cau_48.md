...
**Đề bài:** Xét hàm số f(x) = ax^3 + bx^2 + cx + d (a, b, c, d thuộc R; a > 0) có hai điểm cực trị x1, x2 (với x1 < x2) thỏa mãn x1 + x2 = 0. Hình phẳng giới hạn bởi đường y = f'(x)f''(x) và trục hoành có diện tích bằng 9/4. Biết tích phân từ x1 đến x2 của f'(x)/(3^x + 1) dx = -7/2, giá trị của tích phân từ 0 đến x2 của (x + 2)f''(x) dx thuộc khoảng nào dưới đây?
...
Theo đề bài S = 9/4, suy ra:
c^2 = 9/4
Do c < 0 nên:
c = -3/2.

**Bước 2: Khai thác giả thiết tích phân của f'(x)/(3^x + 1)**
Gọi I = tích phân từ -m đến m của f'(x)/(3^x + 1) dx.
...
Theo đề bài I = -7/2. Thay c = -3/2 vào:
(2/3) * (-3/2) * m = -7/2
- (1/2) * 2 * m = -7/2
-m = -7/2
=> m = 7/2.
...
Hàm f''(x) trở thành:
f''(x) = 6ax = 6(2/49)x = (12/49)x.

Giá trị của tích phân J = tích phân từ 0 đến x2 của (x + 2)f''(x) dx:
J = tích phân từ 0 đến 7/2 của (x + 2)(12/49)x dx
J = (12/49) * tích phân từ 0 đến 7/2 của (x^2 + 2x) dx
J = (12/49) * [ x^3 / 3 + x^2 ] từ 0 đến 7/2
J = (12/49) * [ (343/8) / 3 + 49/4 ]
J = (12/49) * ( 343/24 + 294/24 )
J = (12/49) * ( 637/24 )
J = (12/24) * ( 637/49 )
J = (1/2) * 13
J = 13/2 = 6.5.
...
**Kết luận:**
Giá trị J = 6.5.
Ta thấy 6.5 thuộc khoảng (6; 7) tương ứng với đáp án C.
